...
object UanCheckboxDefaults {
    val containerSize: Dp
        ...
        get() = UanThemeTokens.current.spacing.lg + UanThemeTokens.current.spacing.xxs
    val iconSize: Dp
        @Composable @ReadOnlyComposable
        get() = UanIconographyDefaults.small + UanThemeTokens.current.spacing.xxxs
    val borderWidth: Dp = UanInteractiveDefaults.borderWidth
    val cornerRadius: Dp
        @Composable @ReadOnlyComposable
        get() = UanThemeTokens.current.shapes.smallRadius
