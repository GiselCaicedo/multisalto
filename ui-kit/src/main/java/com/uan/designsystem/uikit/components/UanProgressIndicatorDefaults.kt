...
object UanProgressIndicatorDefaults {
    ...
    val numberedStepSize: Dp
        @Composable
        @ReadOnlyComposable
        get() = UanThemeTokens.current.grid.touchTarget - UanThemeTokens.current.spacing.lg
    val statusStepSize: Dp
        @Composable
        @ReadOnlyComposable
        get() = UanThemeTokens.current.grid.touchTarget - UanThemeTokens.current.spacing.sm
