...
fun UanButton(
    ...
    val verticalPadding: Dp = when (size) {
        UanButtonSize.XSmall -> UanButtonDefaults.xSmallVerticalPadding
        ...
        UanButtonSize.XLarge -> UanButtonDefaults.xLargeVerticalPadding
    }

    val horizontalPadding: Dp = when (size) {
        UanButtonSize.XSmall -> UanButtonDefaults.xSmallHorizontalPadding
        UanButtonSize.Compact -> UanButtonDefaults.compactHorizontalPadding
        UanButtonSize.Regular -> UanButtonDefaults.regularHorizontalPadding
        UanButtonSize.Large -> UanButtonDefaults.largeHorizontalPadding
        UanButtonSize.XLarge -> UanButtonDefaults.xLargeHorizontalPadding
    }
    ...
    Surface(
        ...
        Box(contentAlignment = Alignment.Center) {
            ...
            val indicatorSize: Dp = when (size) {
                UanButtonSize.XSmall -> UanButtonDefaults.compactIndicatorSize
                ...
                UanButtonSize.XLarge -> UanButtonDefaults.largeIndicatorSize
            }
...
fun UanButton(
    ...
    val contentColor: Color = when (style) {
        ...
        UanButtonStyle.Success -> tokens.colors.onSuccess
    }

    val resolvedIconSize: Dp = when (size) {
        UanButtonSize.XSmall -> UanButtonDefaults.xSmallIconSize
        UanButtonSize.Compact -> UanButtonDefaults.compactIconSize
        else -> UanButtonDefaults.iconSize
    }
