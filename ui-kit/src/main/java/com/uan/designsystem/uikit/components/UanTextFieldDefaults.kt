...
object UanTextFieldDefaults {
    ...
    val inputStyle
        @Composable get() = UanThemeTokens.current.typography.general
    ...
    val floatingLabelStyle
        @Composable get() = UanThemeTokens.current.typography.distance

    /** Estilo del mensaje de error. */
    val errorStyle
        @Composable get() = UanThemeTokens.current.typography.small
}
